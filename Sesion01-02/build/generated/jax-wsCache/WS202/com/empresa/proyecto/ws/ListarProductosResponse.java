 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://ws.proyecto.empresa.com/}productoBean" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ListarProductosResponse {
    ...
    protected List<ProductoBean> _return;
     ...
     * 
     */
    public List<ProductoBean> getReturn() {
        if (_return == null) {
            _return = new ArrayList<ProductoBean>();
        }
        return this._return;
    }
